  ...
  >
    ...
    >
      ...
      <div
        ...
        class="overflow-y-auto overflow-x-hidden absolute top-0 right-0 left-0 z-40 flex-1 items-center px-6 py-3 m-2 h-auto bg-white rounded shadow md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none"
      >
        <div
          class="block pb-4 mb-4 border-b border-solid md:min-w-full md:hidden border-slate-200"
        >
        ...
        <!-- Heading -->
        <nav-heading> Admin Layout Pages </nav-heading>
        ...
        <nav-heading> Two-level menu </nav-heading>
