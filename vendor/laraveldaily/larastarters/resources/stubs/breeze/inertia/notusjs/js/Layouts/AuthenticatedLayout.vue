<template>
  ...
  <div class="relative md:ml-64 bg-slate-50">
    <!-- TOP NAV -->
    <nav
      class="hidden absolute top-0 left-0 z-10 items-center p-4 w-full bg-transparent md:flex md:flex-row md:flex-nowrap md:justify-start"
    >
      <div
        class="flex flex-wrap justify-end items-center px-4 mx-auto w-full md:flex-nowrap md:px-10"
      >
        <Dropdown>
          <template #trigger>
