...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).coreui =
        e());
})(this, function () {
  "use strict";
  const t = {
  ...
  const V = {
      ...
      getDataAttribute: (t, e) => U(t.getAttribute(`data-coreui-${z(e)}`)),
      offset(t) {
  ...
  class _t extends B {
    ...
    _addEventListeners() {
      this._config.keyboard && j.on(this._element, nt, (t) => this._keydown(t)),
    ...
    _setActiveIndicatorElement(e) {
      if (this._indicatorsElement) {
        ...
        for (let t = 0; t < n.length; t++)
          if (
            Number.parseInt(n[t].getAttribute("data-coreui-slide-to"), 10) ===
  ...
  class $t extends B {
    ...
    show() {
        ...
        ((e = t
          ...
          .filter((t) =>
            "string" == typeof this._config.parent
              ? t.getAttribute("data-coreui-parent") === this._config.parent
      ...
      if (e) {
        ...
        if (((i = t ? $t.getInstance(t) : null), i && i._isTransitioning))
          return;
      }
      ...
      if (e > 0)
        for (let t = 0; t < e; t++) {
          ...
          i &&
            ...
            (e.classList.add(Nt), e.setAttribute("aria-expanded", !1));
        }
      this.setTransitioning(!0);
      (this._element.style[t] = ""),
        this._queueCallback(
    ...
    _getConfig(t) {
      return (
        ((t = { ...wt, ...t }).toggle = Boolean(t.toggle)), l(vt, t, Et), t
      );
    }
    _getDimension() {
  ...
  function be(t) {
    return "html" === oe(t)
      ? t
      : t.assignedSlot || t.parentNode || (ce(t) ? t.host : null) || ve(t);
  }
  function ye(t) {
  ...
  function we(t) {
    for (var e = re(t), i = ye(t); i && _e(i) && "static" === me(i).position; )
      i = ye(i);
    return i &&
      ("html" === oe(i) || ("body" === oe(i) && "static" === me(i).position))
      ? e
      : i ||
          (function (t) {
    ...
    var n =
        "clippingParents" === e
          ? (function (t) {
              var e = ze(be(t)),
                i =
                  ["absolute", "fixed"].indexOf(me(t).position) >= 0 && le(t)
                    ? we(t)
                    : t;
              return ae(i)
                ? e.filter(function (t) {
  ...
  function Qe(t, e) {
    ...
    var i = e,
      ...
      w = Ye({ reference: y, element: _, strategy: "absolute", placement: s }),
          ...
          return (
            (t[i] = (function (t, e, i) {
              ...
              return (
                (r = r || 0),
                (a = (a || 0) * s),
                [Ht, Pt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
              );
            })(i, e.rects, o)),
            t
          );
  ...
  var ni = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        p = i.tetherOffset,
        g = void 0 === p ? 0 : p,
        m = Qe(e, { boundary: l, rootBoundary: c, padding: d, altBoundary: h }),
        _ = de(e.placement),
        v = De(e.placement),
        b = !v,
        y = Ee(_),
        ...
        (("body" !== oe(e) || qe(a)) &&
          (c =
            (n = e) !== re(n) && le(n)
              ...
              : Re(n)),
        le(e)
          ? (((h = fe(e, !0)).x += e.clientLeft), (h.y += e.clientTop))
          : a && (h.x = We(a))),
      {
    ...
    static dataApiKeydownHandler(e) {
      if (
        /input|textarea/i.test(e.target.tagName)
          ? e.key === mi ||
            (e.key !== gi &&
              ((e.key !== vi && e.key !== _i) || e.target.closest(Di)))
          : !bi.test(e.key)
      )
        return;
      ...
      return e.key === gi
        ...
        : e.key === _i || e.key === vi
        ? (i || n().click(), void Bi.getInstance(n())._selectMenuItem(e))
  ...
  class Yi {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Ui, ...("object" == typeof t ? t : {}) }).rootElement = a(
          t.rootElement
        )),
        l(Vi, t, zi),
        t
  ...
  class dn extends B {
    ...
    show(t) {
      ...
      j.trigger(this._element, en, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
    ...
    _triggerBackdropTransition() {
      if (
        j.trigger(this._element, "hidePrevented.coreui.modal").defaultPrevented
      )
        return;
  ...
  class Wn extends B {
    ...
    show(t) {
      ...
      if (j.trigger(this._element, In, { relatedTarget: t }).defaultPrevented)
        return;
      (this._isShown = !0),
        (this._element.style.visibility = "visible"),
        this._backdrop.show(),
        this._config.scroll ||
          (new qi().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
  ...
  const qn = new Set([
    ...
    Vn = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !qn.has(i) || Boolean(Un.test(t.nodeValue) || zn.test(t.nodeValue))
        );
  ...
  class ls extends B {
    ...
    show() {
      ...
      H.set(n, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = di(this._element, n, this._getPopperConfig(r))),
        n.classList.add(ns);
      const l =
        ...
        return r(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = Kn(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _getConfig(t) {
      ...
      return (
        ...
        t.sanitize && (t.template = Kn(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
  ...
  class Vs extends B {
    ...
    reset() {
      this._isMobile() ||
        ...
        this._unfoldable &&
          (this._element.classList.remove(Ps), (this._unfoldable = !1)));
    }
    toggleNarrow() {
  ...
  class Gs extends B {
    ...
    show() {
      ...
      const o = e
        ? j.trigger(e, "hide.coreui.tab", { relatedTarget: this._element })
        : null;
      if (
        j.trigger(this._element, "show.coreui.tab", { relatedTarget: e })
          .defaultPrevented ||
      ...
      const r = () => {
        j.trigger(e, "hidden.coreui.tab", { relatedTarget: this._element }),
          j.trigger(this._element, "shown.coreui.tab", { relatedTarget: e });
      };
    ...
    _transitionComplete(e, i, n) {
      ...
      if (
        ...
        i && t.find(".dropdown-toggle", i).forEach((t) => t.classList.add(Fs)),
